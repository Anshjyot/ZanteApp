...
struct HomeStories: View {
  ...
  var body: some View {
    ScrollView(.horizontal, showsIndicators: false) {
      HStack(spacing: 16) {
        StoryView(image: "person_1", name: "1")
        StoryView(image: "person_2", name: "2")
        StoryView(image: "person_3", name: "3")
        StoryView(image: "person_4", name: "4")
        StoryView(image: "person_5", name: "5")
        StoryView(image: "person_6", name: "6")
      }
